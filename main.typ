...
#figura_legendada(
	image("imagens/hierarquia_paradigmas.png", height: 80%),
...
#figura_legendada(
	image("imagens/diagrama_ecs.png", height: 75%),
...
#grid(
	...
	image("imagens/diagrama_agendador.png"),
)
...
#grid(
	...
	figura_legendada(
		image("imagens/flecs_explorer.png"),
...
#figura_legendada(
	image("imagens/entidade_posicao.png"),
...
#figura_legendada(
	image("imagens/relacionamento_entidades.png"),
...
#figura_legendada(
	image("imagens/mapa_interpretador.png", height: 65%),
...
#figura_legendada(
	image("imagens/analise_lexica.png", height: 80%),
...
#figura_legendada(
	image("imagens/analise_sintatica.png", height: 80%),
	[Fonte: baseado em #cite(<craftinginterpreters>, form: "prose").],
)
...
#figura_legendada(
	image("imagens/interpretacao.png", height: 80%),
	[Fonte: baseado em #cite(<craftinginterpreters>, form: "prose").],
)
